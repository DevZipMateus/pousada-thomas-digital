        ...
        <div className="flex flex-col items-center text-center space-y-8">
          ...
          <div className="space-y-3 text-muted-foreground">
            ...
            <div className="flex items-center justify-center gap-2">
              ...
              <a
                href="mailto:contato@pousadathomas.com.br"
          ...
          <div className="flex gap-4">
            <a
              href="https://instagram.com/pousadathomas"
              target="_blank"
            ...
            <a
              href="https://facebook.com/pousadathomas"
              target="_blank"
              rel="noopener noreferrer"
              className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center text-primary hover:bg-primary hover:text-primary-foreground transition-colors"
              aria-label="Facebook"
          ...
          <div className="text-sm text-muted-foreground pt-6 border-t border-border w-full">
            <p>2021 ©Pousada Thomas - Todos os direitos reservados</p>
          </div>
        </div>
      </div>
    </footer>
